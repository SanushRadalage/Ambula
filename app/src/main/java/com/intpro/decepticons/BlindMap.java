...
public class BlindMap extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener, RoutingListener {
       ...
       /* tips.setOnClickListener(new View.OnClickListener() {
        ...
        mlogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BlindMap.this, MainActivity.class);
                startActivity(intent);
                finish();
                return;
            }
